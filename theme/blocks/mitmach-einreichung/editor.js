        ...
        edit: function ( props ) {
            ...
            return el(
                ...
                el( InspectorControls, null,
                    el( PanelBody, { title: 'Abschnittstitel', initialOpen: true },
                        f( 'Abschnitt 1: Beitrag', 'sectionBeitrag' ),
                        f( 'Abschnitt 2: Ort', 'sectionOrt' ),
                        f( 'Abschnitt 3: Kontakt', 'sectionKontakt' )
                    ),
